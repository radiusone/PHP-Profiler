...
class Profiler_Display {
    ...
    public static function display($output) {
        ...
        echo <<< HTML
        <div id="profiler-container" class="profiler hideDetails" style="display: none;">
        <div id="profiler" class="console">
        <table id="profiler-metrics" cellspacing="0">
        <tr>
        <td id="console" class="tab" style="color: #588E13;">
        <var>$logCount</var>
        <h4>Console</h4>
        </td>
        <td id="speed" class="tab" style="color: #3769A0;">
        <var>$speedTotal</var>
        <h4>Load Time</h4>
        </td>
        <td id="queries" class="tab" style="color: #953FA1;">
        <var>$queryCount Queries</var>
        <h4>Database</h4>
        </td>
        <td id="memory" class="tab" style="color: #D28C00;">
        <var>$memoryUsed</var>
        <h4>Memory Used</h4>
        </td>
        ...
        // Start Console tab
        echo <<< HTML
        <div id="profiler-console" class="profiler-box" style="background: url(data:image/gif;base64,$overlay_image); border-top: 1px solid #ccc; height: 200px; overflow: auto;">
        HTML;
        ...
        if ($logCount ==  0) {
            ...
            <tr>
            <td class="console-log" id="console-log"><var>{$output['logs']['console']['count']}</var><h4>Logs</h4></td>
            <td class="console-errors" id="console-error"><var>{$output['logs']['errors']['count']}</var> <h4>Errors</h4></td>
            </tr>
            <tr>
            <td class="console-memory" id="console-memory"><var>{$output['logs']['memory']['count']}</var> <h4>Memory</h4></td>
            <td class="console-speed" id="console-speed"><var>{$output['logs']['speed']['count']}</var> <h4>Speed</h4></td>
            </tr>
            <tr>
            <td class="console-benchmarks" id="console-benchmark"><var>{$output['logs']['benchmarks']['count']}</var><h4>Benchmarks</h4></td>
            </tr>
            </table>
        ...
        if ($output['queryTotals']['count'] ==  0) {
            ...
            <tr><td class="alt">
            <var>{$output['queryTotals']['types']['select']['total']} ({$output['queryTotals']['types']['select']['percentage']}%)</var>
            <var>{$output['queryTotals']['types']['select']['time']} ({$output['queryTotals']['types']['select']['time_percentage']}%)</var>
            <h4>Selects</h4>
            </td></tr>
            <tr><td>
            <var>{$output['queryTotals']['types']['update']['total']} ({$output['queryTotals']['types']['update']['percentage']}%)</var>
            <var>{$output['queryTotals']['types']['update']['time']} ({$output['queryTotals']['types']['update']['time_percentage']}%)</var>
            <h4>Updates</h4>
            </td></tr>
            <tr><td class="alt">
            <var>{$output['queryTotals']['types']['insert']['total']} ({$output['queryTotals']['types']['insert']['percentage']}%)</var>
            <var>{$output['queryTotals']['types']['insert']['time']} ({$output['queryTotals']['types']['insert']['time_percentage']}%)</var>
            <h4>Inserts</h4>
            </td></tr>
            <tr><td>
            <var>{$output['queryTotals']['types']['delete']['total']} ({$output['queryTotals']['types']['delete']['percentage']}%)</var>
            <var>{$output['queryTotals']['types']['delete']['time']} ({$output['queryTotals']['types']['delete']['time_percentage']}%)</var>
            <h4>Deletes</h4>
            </td></tr>
            </table>
            <table class="main" cellspacing="0">
        ...
        // Start Memory tab
        echo <<< HTML
        <div id="profiler-memory" class="profiler-box" style="background: url(data:image/gif;base64,$overlay_image); border-top: 1px solid #ccc; height: 200px; overflow: auto;">
        HTML;
        ...
        if ($output['fileTotals']['count'] ==  0) {
            ...
            echo <<< HTML
            <table class="side" cellspacing="0">
            <tr><td style="$side_bg_style"><var>{$output['fileTotals']['count']}</var><h4>Total Files</h4></td></tr>
            <tr><td class="alt" style="$side_bg_style"><var>{$output['fileTotals']['size']}</var> <h4>Total Size</h4></td></tr>
            <tr><td style="$side_bg_style"><var>{$output['fileTotals']['largest']}</var> <h4>Largest</h4></td></tr>
            </table>
            <table class="main" cellspacing="0">
            HTML;
        ...
        // Start Footer
        echo <<< HTML
        <table id="profiler-footer" cellspacing="0">
        <tr>
        <td class="credit"><strong>PHP</strong>&nbsp;Profiler</td>
        <td class="actions">
